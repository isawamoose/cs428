  ...
  return (
    <div className="settings-page">
      <dialog ref={dialogRef}>
        ...
        <p>
          Doing so will delete all of your account data including{" "}
          <b>previous matches, login information, and account settings</b> as
          well.
        </p>
        <button className="big-text" onClick={() => dialogRef.current?.close()}>
      ...
      <div className="settings-links">
        <Link to={"/app/settings/edit-profile"}>
          <p>Edit Profile</p>
          <LuChevronRight />
        </Link>
